...
import {isValidJalaaliDate, toGregorian} from "../utils/test";

console.log(isValidJalaaliDate(2003, 12, 30));

describe("toGregorian", () => {
  // it("toGregorian", () => {
  //   const result = toGregorian(new Date("1399-12-6"));
